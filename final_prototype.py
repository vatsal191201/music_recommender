...
def calculate_weighted_cosine_similarity(input_song_index, weights, num_songs_to_output, tracks_data, scaler_choice):
    ...
    # Convert input_song_index to integer if it's not already
    input_song_index = int(input_song_index)

    # Calculate cosine similarities
    cosine_similarities = cosine_similarity(tracks_sparse[input_song_index:input_song_index+1], tracks_sparse).flatten()
